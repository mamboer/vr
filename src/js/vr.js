...
(function(W, D, O) {
    ...
    var proto = "https:" === location.protocol ? "http://" : "http://",
        jq = D.createElement("script"),
        js0 = D.getElementsByTagName("script")[0],
        bootup,
        VR = {};
    
    jq.src = proto + "cdnjs.cloudflare.com/ajax/libs/jquery/2.1.4/jquery.min.js";
    js0.parentNode.insertBefore(jq, js0);
    D.close();

    

    bootup = function(cbk) {
        if (W.jQuery && jQuery.fn.jquery === "2.1.4") return cbk(jQuery);

        //TODO: 使用setInterval优化      
  
        W.jQuery && jQuery.noConflict();
    ...
    VR.tpl = new mintpl.heredoc(function(){/*!
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1"/>
        <link rel="stylesheet" href="<%=css%>"/>
        <style type="text/css" media="print"/>
        <div id="expand"></div>
        <dl></dl>
        <a id="bookmarklet" data-text="Your bookmarklet"><span>↔ Resizer</span></a>
        <span class="invisible"> has been changed. Please save or update your bookmarklet.</span>,
        <div id="toolbar" data-resizer="basic"></div>》
            n = a('<ul id="devices">'),
            H = a('<ul id="tools">'),
    ...
    */});
    ...
    VR.init = function($) {
        ...
        function z(b) {
            b = typeof b === "undefined" ? $("a.active", n) : $(b);
            var e = b.attr("data-viewport").toDimension();
            $("a.active", n).add($("a.active", H)).removeClass("active").end(b.addClass("active"));
            ga(e);
        };
        function A(b, e) {
        ...
        function Fa() {
            ...
            if (h) if (h !== "device-width") u = Number(h);
            else f = g = false;
            else u = 980;
        ...
        function la() {
            ...
            if (!ma) {
                ...
                a.event.special.mousewheel = {
                    setup: function() {
                        if (this.addEventListener) for (var f = b.length; f;) this.addEventListener(b[--f], d, false);
                ...
                var d = function(f) {
                    ...
                    if (l.wheelDeltaX !== O) q = -1 * l.wheelDeltaX / 120;
                    k.unshift(f, j, q, s);
        ...
        var Ja = version = "{{version}}", //Ja = version
